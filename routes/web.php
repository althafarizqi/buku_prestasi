...
Route::delete('/bulanandetail/{id}', [DetailBulananController::class, 'destroy'])->name('bulanandetail.destroy');
...
Route::post('/backup/dbonly', [BackupController::class, 'backupDB'])
    ->name('backup.dbonly');
...
Route::middleware(['auth'])->group(function(){
    ...
    Route::put('/pengampu/{id}', [PengampuController::class, 'update'])->name('pengampu.update');
    Route::delete('/pengampu/{id}', [PengampuController::class, 'destroy'])->name('pengampu.destroy');
    ...
    Route::post('/surah', [SurahController::class, 'store'])->name('surah.store');
    Route::get('/surah/{id}/edit', [SurahController::class, 'edit'])->name('surah.edit');
    Route::put('/surah/{id}', [SurahController::class, 'update'])->name('surah.update');
    Route::delete('/surah/{id}', [SurahController::class, 'destroy'])->name('surah.destroy');
