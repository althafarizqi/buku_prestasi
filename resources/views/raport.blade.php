...
<head>
    <style>
        ...
        body::before {
            ...
            width: 100%;
            height: 100%;
            background-color: rgba(255, 255, 255, 0.774); /* Sesuaikan dengan warna dan tingkat transparansi yang diinginkan */
...
<body>
                    ...
                    <table style="border: 0px solid black; width: 750px;">
                        <tr style="border: 0px solid black;">
                            <td colspan="3" style="border: 0px solid black; width: 120px;">
                                <p style="text-align: center; font-weight: bold; font-size: 16px; margin-top: -5px">RAPORT TAHFIDZ AKHIR
                                    SEMESTER
                                    {{$semester}}
                    ...
                    <tbody>
                        ...
                        <tr style="text-align: center;">
                            ...
                            <td
                                style="text-align: left; border-right: 1px solid black; border-bottom: 1px solid black; width: 200px;">
                                &nbsp;{{$bulanan->nama}}</td>
                            <td style="border-right: 1px solid black; border-bottom: 1px solid black; width: 150px;">
                                {{$bulanan->murrum}}</td>
                            <td style="border-right: 1px solid black; border-bottom: 1px solid black; width: 150px;">
                                {{$bulanan->mursek}}</td>
                            <td style="border-right: 1px solid black; border-bottom: 1px solid black;">
                        ...
                        <tr style="text-align: left;">
                            <td colspan="6"
                                ...
                                <p>Alhamdulillah, ananda <span
                                    ...
                                    surah @php
                                        $teks_lengkap =  $hafalandetail->last()->nama;
                                        // Periksa apakah teks mengandung tanda '-'
                                        if (strpos($teks_lengkap, '-') !== false) {
                                            $bagian = explode(' - ', $teks_lengkap);

                                            // Periksa apakah ada lebih dari satu elemen dalam array
                                            if (count($bagian) > 1 && isset($bagian[1])) {
                                                echo $bagian[1];
                                            } else {
                                                echo $bagian[0];
                                            }
                                        } else {
                                            // Tidak ada tanda '-' dalam teks, tampilkan teks utuh
                                            echo $teks_lengkap;
                                        }
                                    @endphp
    ...
    <tr>
        <td>
            <table style="border: 0px solid black; width: 800px;">
                <tr style="border: 0px solid black;">
                    <td colspan="2" style="border: 0px solid black; width: 250px; text-align: center; ">
                        Kepala
