...
@section('content')
<form action="{{ route('ukjdetail.update', ['id' => $detail->id]) }}" method="post">
    @method('PUT')
    @csrf
    <table class="table table-responsive">
        ...
        <tbody align="center">
            <tr>
                <td><span class="text-left text-bold">{{$ukjdetail->first()->nama}}</span></td>
                <td>
                ...
                <td class="row">
                    <div><button class="btn btn-primary form-control" type="submit"><h5>Update</h5></button></div>
                    <div><a class="ml-1 btn btn-warning form-control" href="javascript:history.back()"><h5>Batal</h5></a></div>
                </td>
            </tr>
        </tbody>
